...
def sma_return(ticker, short_window, INITIAL_CAPITAL=17.0*1000.0, step_buy_th=STEP_BUY_THERESHOLD, step_sell_th=STEP_SELL_THRESHOLD, START_DATE=START_DATE, END_DATE=END_DATE):
	...
	for i in range(size):
		...
		if adjusted_close > short_mavg and adjusted_close > long_mavg and i > 30 and buy_flag and capital > 500 and step_buy > step_buy_th:
			if fprint:
		...
		elif adjusted_close < short_mavg and i > 30 and sell_flag and step_sell>step_sell_th:
			if fprint:
